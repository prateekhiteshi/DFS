...
const Slider = ()=>{
  ...
  const filterImage = (title, type="fixed")=>{
    ...
    return image && image.length>0?
      image[0].node[type] : null
  }

  const sliderBG = filterImage('banner background image')
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 slider-img">
                  <AMPImage data={ filterImage('Home page slider image reports') } alt="slider img 1" />
                  <amp-img className="slider-img-bottom" src={ general.src } srcSet={ general.srcSet } alt="general" width="550" height="120" ></amp-img>
                </div>
              </div>
            </div>
            <div className="carousel-item">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 slider-img">
                  <AMPImage data={ filterImage('Home page slider image data points') } alt="slider img 2" />
                  <amp-img src={ general.src } srcSet={ general.srcSet } alt="general" width="550" height="120" ></amp-img>
                </div>
              </div>
            </div>
            <div className="carousel-item">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 slider-img">
                  <AMPImage data={ filterImage('Home page slider image online shopping') } alt="slider img 2" />
                  <amp-img src={ general.src } srcSet={ general.srcSet } alt="general" width="550" height="120" ></amp-img>
                </div>
              </div>
            </div>
            <div className="carousel-item">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 slider-img">
                  <AMPImage data={ filterImage('Home page slider image value engineering service') } alt="slider img 4" />
                  <amp-img src={ general.src } srcSet={ general.srcSet } alt="general" width="550" height="120" ></amp-img>
                </div>
              </div>
            </div>
            <div className="carousel-item">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 slider-img">
                  <AMPImage data={ filterImage('Home page slider image woocommerce') } alt="slider img 5" />
                  <amp-img src={ general.src } srcSet={ general.srcSet } alt="general" width="550" height="120" ></amp-img>
                </div>
              </div>
            </div>
            <div className="carousel-item">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 slider-img">
                  <AMPImage data={ filterImage('Home page slider image megento') } alt="slider img 6" />
                  <amp-img src={ general.src } srcSet={ general.srcSet } alt="general" width="550" height="120" ></amp-img>
                </div>
              </div>
            </div>
            <div className="carousel-item">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 slider-img">
                  <AMPImage data={ filterImage('Home page slider image wordpress woocommerce') } alt="slider img 6" />
                  <amp-img src={ general.src } srcSet={ general.srcSet } alt="general" width="550" height="120" ></amp-img>
                </div>
              </div>
            </div>
            <div className="carousel-item">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 slider-img">
                  <AMPImage data={ filterImage('Home page slider image lead generation') } alt="slider img 7" />
                  <amp-img src={ general.src } srcSet={ general.srcSet } alt="general" width="550" height="120" ></amp-img>
                </div>
              </div>
            </div>
            <div className="carousel-item">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 slider-img">
                  <AMPImage data={ filterImage('Home page slider image QA engineers') } alt="slider img 8" />
                  <amp-img src={ general.src } srcSet={ general.srcSet } alt="general" width="550" height="120" ></amp-img>
                </div>
              </div>
            </div>
            <div className="carousel-item">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 slider-img">
                  <AMPImage data={ filterImage('Home page slider image maintenance') } alt="slider img 9" />
                  <amp-img src={ general.src } srcSet={ general.srcSet } alt="general" width="550" height="120" ></amp-img>
                </div>
              </div>
            </div>
            <div className="carousel-item">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 slider-img">
                  <AMPImage data={ filterImage('Home page slider image what do we do') } alt="slider img 10" />
                  <amp-img src={ general.src } srcSet={ general.srcSet } alt="general" width="550" height="120" ></amp-img>
                </div>
              </div>
            </div>
            <div className="carousel-item">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 slider-img">
                  <AMPImage data={ filterImage('Home page slider image moving forward') } alt="slider img 11" />
                  <amp-img src={ general.src } srcSet={ general.srcSet } alt="general" width="550" height="120" ></amp-img>
                </div>
              </div>
            </div>
            <div className="carousel-item">
              <div className="row">
                ...
                <div className="col-lg-10 col-md-10 text-center">
                  ...
                  <amp-img src={ general.src } srcSet={ general.srcSet } alt="general" width="750" height="250" ></amp-img>
                </div>
              </div>
            </div>
          </div>

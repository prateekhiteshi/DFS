...
const ContactAMPPage = ({ pageContext: { contactUs, seo } }) => {
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-md-6">
              <form
                method="post"
                action-xhr="https://api.contentful.com/spaces/gt4nxopyo75x/environments/master/entries"
                target="_top"
